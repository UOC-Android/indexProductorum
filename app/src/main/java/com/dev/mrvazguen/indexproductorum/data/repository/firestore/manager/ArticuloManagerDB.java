...
public class ArticuloManagerDB extends FirebaseDao<Producto>
{
    ...
    @Override
    public void append(Producto articulo, iFirestoreNotification transactionNotification) {
        FirebaseFirestore db = FirebaseFirestore.getInstance();
        String TAG = "Apend_ARticuloManager";
        //articulosCR.document(articulo.getCategoria().get(0)).set(articulo);

        db.collection(GlobarArgs.DB_SHOPING)
    ...
    @Override
    public void readLiveDate(ArrayList<Producto> list, Object tipoClase) {
